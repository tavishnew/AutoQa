  ...
  head: () => ({
    meta: [
      ...
      { title: "AutoQA — AI QA Engineer" },
      {
        name: "description",
        content:
          "AutoQA discovers your app, generates browser and API tests, runs them, and explains failures. Local-first AI QA engineering.",
      },
      { name: "author", content: "AutoQA" },
      ...
      { name: "twitter:site", content: "@autoqa" },
    ],
    links: [
